...
export const lightTheme = {
  body: CONSTANTS.COLORS.zinc50,
  headerTitle: CONSTANTS.COLORS.zinc800,
  headerSubtitle: CONSTANTS.COLORS.zinc500,
...
export const darkTheme = {
  body: CONSTANTS.COLORS.zinc900,
  headerTitle: CONSTANTS.COLORS.zinc200,
  headerSubtitle: CONSTANTS.COLORS.zinc400,
